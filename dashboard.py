...
with tab5:
    ...
    col3, col4 = st.columns(2)
    with col3:
        st.markdown('<div class="section-header">\U0001F4B1 Exchange Rate Over Time (Selected Countries)</div>', unsafe_allow_html=True)
    ...
    with col4:
        st.markdown('<div class="section-header">\U0001F4C8 Inflation Rate Over Time</div>', unsafe_allow_html=True)
        fig_inf_ts = px.line(
    ...
    # Season factor
    st.markdown('<div class="section-header">\U00002600 Season Factor Distribution</div>', unsafe_allow_html=True)
    fig_sf = px.histogram(
